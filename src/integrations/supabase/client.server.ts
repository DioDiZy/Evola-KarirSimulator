...
// Uses the new Supabase Secret Key, with fallback to legacy Service Role Key.
...
function createSupabaseFetch(supabaseKey: string): typeof fetch {
  return (input, init) => {
    ...
    // New Supabase API keys are opaque strings, not JWTs.
    if (
...
function createSupabaseAdminClient() {
  ...
  // Prioritaskan API key baru.
  // Fallback agar project lama tetap kompatibel.
